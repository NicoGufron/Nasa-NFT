...
const MintPage: NextPage = () => {
    ...
    var [tempFlag, setTempFlag] = useState(false);
    var flag;
    ...
    async function connectWallet() {
        ...
        if (chainId == 1) { //jangan lupa diganti jadi chainId != 1
            ...
            if (accounts.length > 0) {
                ...
                flag = checkAddress(provider, accounts[0]);
    ...
    async function checkAddress(provider: any, address: any) {
    ...
    async function mint() {
        ...
        await contract.mint(1, {from: accounts[0], value: mintPrice, gasPrice: gasPrice, gasLimit: ethers.utils.hexlify(150000), nonce: undefined})
    ...
    return (
        <>
            <div className='head-section'>
                ...
                <div className="mint-section" style={{ display: tempFlag ? "none" : "flex" }}>
                    <h1>Sorry, You are not whitelisted!</h1>
                </div>
                <div className="mint-section" style={{ display: tempFlag ? "flex" : "none" }}>
                    ...
                    <button className="nasa-button" onClick={mint}>{mintText}</button>
                </div>
            </div>
        </>
    );
